  ...
  (lm.utils.F = function() {}),
    ...
    (lm.utils.fnBind = function(t, e, i) {
      if (void 0 !== Function.prototype.bind)
        return Function.prototype.bind.apply(t, [e].concat(i || []));
      var n = function() {
    ...
    (lm.utils.EventEmitter = function() {
      (this._mSubscriptions = {}),
        ...
        (this.on = function(t, e, i) {
          ...
          this._mSubscriptions[t] || (this._mSubscriptions[t] = []),
            this._mSubscriptions[t].push({ fn: e, ctx: i });
        }),
        (this.emit = function(t) {
          var e, i, n;
          if (
            ((n = Array.prototype.slice.call(arguments, 1)),
            this._mSubscriptions[t])
          )
            for (e = 0; e < this._mSubscriptions[t].length; e++)
              (i = this._mSubscriptions[t][e].ctx || {}),
                this._mSubscriptions[t][e].fn.apply(i, n);
          for (
            n.unshift(t), e = 0;
            e < this._mSubscriptions[lm.utils.EventEmitter.ALL_EVENT].length;
            e++
          )
            (i =
              this._mSubscriptions[lm.utils.EventEmitter.ALL_EVENT][e].ctx ||
              {}),
              this._mSubscriptions[lm.utils.EventEmitter.ALL_EVENT][e].fn.apply(
                i,
                n
              );
        }),
        (this.unbind = function(t, e, i) {
          if (!this._mSubscriptions[t])
            throw new Error('No subscribtions to unsubscribe for event ' + t);
          var n,
            s = !1;
          for (n = 0; n < this._mSubscriptions[t].length; n++)
            (e && this._mSubscriptions[t][n].fn !== e) ||
              (i && i !== this._mSubscriptions[t][n].ctx) ||
              (this._mSubscriptions[t].splice(n, 1), (s = !0));
    ...
    lm.utils.copy(lm.utils.DragListener.prototype, {
        ...
        if (null != this._timeout) {
          ...
          (this._nX = e.x - this._nOriginalX),
            ...
            this._bDragging === !1 &&
              ...
              (clearTimeout(this._timeout), this._startDrag()),
      ...
      onMouseUp: function(t) {
        null != this._timeout &&
          ...
          this._bDragging === !0 &&
            ((this._bDragging = !1),
            this.emit('dragStop', t, this._nOriginalX + this._nX)));
      },
      _startDrag: function() {
        (this._bDragging = !0),
    ...
    (lm.LayoutManager = function(t, e) {
      ...
      lm.utils.EventEmitter.call(this),
        ...
        (this._maximisePlaceholder = $(
          '<div class="lm_maximise_place"></div>'
        )),
    ...
    lm.utils.copy(lm.LayoutManager.prototype, {
      ...
      toConfig: function(t) {
          ...
          e = {
            ...
            i = function(t, e) {
              ...
              if (e.contentItems.length)
                for (t.content = [], s = 0; s < e.contentItems.length; s++)
                  (t.content[s] = {}), i(t.content[s], e.contentItems[s]);
            },
        ...
        return (
          (e.maximisedItemId = this._maximisedItem ? '__glMaximised' : null), e
        );
      },
      ...
      init: function() {
        return (
          this._subWindowsCreated === !1 &&
            (this._createSubWindows(), (this._subWindowsCreated = !0)),
          'loading' === document.readyState || null === document.body
            ...
            ? (setTimeout(lm.utils.fnBind(this.init, this), 7),
              void (this._creationTimeoutPassed = !0))
      ...
      destroy: function() {
        this.isInitialised !== !1 &&
          ...
          this._dragSources.forEach(function(t) {
            t._dragListener.destroy(),
              (t._element = null),
              (t._itemConfig = null),
              (t._dragListener = null);
          }),
          (this._dragSources = []));
      },
      createContentItem: function(t, e) {
        ...
        if (
          ('react-component' === t.type &&
            ((t.type = 'component'), (t.componentName = 'lm-react-component')),
          !this._typeToItem[t.type])
        )
          throw ((i =
            "Unknown type '" +
            t.type +
          ...
          new lm.errors.ConfigurationError(i));
        return (
          'component' !== t.type ||
            e instanceof lm.items.Stack ||
            !e ||
            (this.isSubWindow === !0 && e instanceof lm.items.Root) ||
            (t = {
              type: 'stack',
              width: t.width,
              height: t.height,
      ...
      createPopout: function(t, e, i, n) {
        ...
        if (((i = i || null), c)) {
          for (
            m = this.toConfig(t).content,
              i = lm.utils.getUniqueId(),
              a = t.parent,
              h = t;
            1 === a.contentItems.length && !a.isRoot;

          )
            (a = a.parent), (h = h.parent);
          a.addId(i), isNaN(n) && (n = lm.utils.indexOf(h, a.contentItems));
        } else m instanceof Array || (m = [m]);
        return (
          !e &&
            c &&
            ((s = window.screenX || window.screenLeft),
            (o = window.screenY || window.screenTop),
            (r = t.element.offset()),
            (e = {
              left: s + r.left,
              top: o + r.top,
      ...
      selectItem: function(t, e) {
        ...
        t !== this.selectedItem &&
          (null !== this.selectedItem && this.selectedItem.deselect(),
          t && e !== !0 && t.select(),
          (this.selectedItem = t),
          this.emit('selectionChanged', t));
      },
      _$maximiseItem: function(t) {
        null !== this._maximisedItem &&
      ...
      _$calculateItemAreas: function() {
        ...
        if (((this._itemAreas = []), 1 === allContentItems.length))
          return void this._itemAreas.push(this.root._$getArea());
        for (
          this._$createRootItemAreas(), i = 0;
          i < allContentItems.length;
          i++
        )
          if (
            allContentItems[i].isStack &&
            ((area = allContentItems[i]._$getArea()), null !== area)
          )
            if (area instanceof Array)
              ...
              this._itemAreas.push(area);
              var header = {};
              with ((lm.utils.copy(header, area),
              lm.utils.copy(
                header,
      ...
      _$normalizeContentItem: function(t, e) {
        ...
        if (
          (lm.utils.isFunction(t) && (t = t()),
          t instanceof lm.items.AbstractContentItem)
        )
          return t;
      ...
      _$reconcilePopoutWindows: function() {
        ...
        for (t = 0; t < this.openPopouts.length; t++)
          this.openPopouts[t].getWindow().closed === !1
            ? e.push(this.openPopouts[t])
            : this.emit('windowClosed', this.openPopouts[t]);
        this.openPopouts.length !== e.length &&
          (this.emit('stateChanged'), (this.openPopouts = e));
      },
      ...
      _createConfig: function(t) {
        ...
        e &&
          ...
          (t = JSON.parse(t)),
          (t = new lm.utils.ConfigMinifier().unminifyConfig(t)),
          localStorage.removeItem(e)),
          (t = $.extend(!0, {}, lm.config.defaultConfig, t));
        var i = function(t) {
          for (var e in t)
            'props' !== e && 'object' == typeof t[e]
              ? i(t[e])
              : 'type' === e &&
                'react-component' === t[e] &&
                ((t.type = 'component'),
                (t.componentName = 'lm-react-component'));
        };
        return (
          i(t),
      ...
      _adjustToWindowMode: function() {
        var t = $(
          '<div class="lm_popin" title="' +
            ...
            '"><div class="lm_icon"></div><div class="lm_bg"></div></div>'
        );
        t.click(
      ...
      _create: function(t) {
        ...
        if (!(t.content instanceof Array))
          ...
          new lm.errors.ConfigurationError(e, t));
        if (t.content.length > 1)
          throw ((e = "Top level content can't contain more then one element."),
          new lm.errors.ConfigurationError(e, t));
        (this.root = new lm.items.Root(
          ...
          '__glMaximised' === t.maximisedItemId &&
            this.root.getItemsById(t.maximisedItemId)[0].toggleMaximise();
      },
      _onUnload: function() {
      ...
      _adjustColumnsResponsive: function() {
        if (
          ...
          0 === this.root.contentItems.length ||
        ...
        if (!(t <= 1)) {
          ...
          if (!(i <= this.width)) {
            ...
            for (
              var n = Math.max(Math.floor(this.width / e), 1),
                s = t - n,
                o = this.root.contentItems[0],
                r = this._findAllStackContainers()[0],
                a = 0;
              a < s;
              a++
            ) {
      ...
      _useResponsiveLayout: function() {
        return (
          ...
          ('always' == this.config.settings.responsiveMode ||
            ('onload' == this.config.settings.responsiveMode &&
              this._firstLoad))
        );
      },
      ...
      _findAllStackContainersRecursive: function(t, e) {
        e.contentItems.forEach(
          lm.utils.fnBind(function(e) {
            'stack' == e.type
              ? t.push(e)
              : e.isComponent || this._findAllStackContainersRecursive(t, e);
          }, this)
        );
      }
    }),
    ...
    lm.utils.copy(lm.container.ItemContainer.prototype, {
      ...
      show: function() {
        this.emit('show'),
          (this.isHidden = !1),
          this._element.show(),
          (0 == this.height && 0 == this.width) || this.emit('shown');
      },
      setSize: function(t, e) {
        for (
          var i, n, s, o, r, a, h = this.parent, l = this;
          !h.isColumn && !h.isRow;

        )
          if (((l = h), (h = h.parent), h.isRoot)) return !1;
        for (
          s = h.isColumn ? 'height' : 'width',
            o = 'height' === s ? e : t,
            i = this[s] * (1 / (l.config[s] / 100)),
            n = (o / i) * 100,
            r = (l.config[s] - n) / (h.contentItems.length - 1),
            a = 0;
          a < h.contentItems.length;
          a++
        )
          h.contentItems[a] === l
            ? (h.contentItems[a].config[s] = n)
            : (h.contentItems[a].config[s] += r);
    ...
    lm.utils.copy(lm.controls.BrowserPopout.prototype, {
      ...
      popIn: function() {
        ...
        this._parentId &&
          ...
          e ||
            ((e =
              this._layoutManager.root.contentItems.length > 0
                ? this._layoutManager.root.contentItems[0]
            ...
            (t = setInterval(
              lm.utils.fnBind(function() {
                this._popoutWindow.__glInstance &&
                  ...
                  (this._onInitialised(), clearInterval(t));
              }, this),
              10
            ));
        else if (
          this._layoutManager.config.settings.blockedPopoutsThrowError === !0
        ) {
      ...
      _createUrl: function() {
        ...
        try {
          ...
          throw new Error(
            'Error while writing to localStorage ' + n.toString()
          );
        }
        return (
          ...
          1 === t.length
            ? t[0] + '?gl-window=' + i
            : document.location.href + '&gl-window=' + i
        );
      },
    ...
    (lm.controls.DragProxy = function(t, e, i, n, s, o) {
      lm.utils.EventEmitter.call(this),
        ...
        o &&
          o._side &&
          ((this._sided = o._sided),
          this.element.addClass('lm_' + o._side),
          ['right', 'bottom'].indexOf(o._side) >= 0 &&
            this.element
              .find('.lm_content')
    ...
    lm.utils.copy(lm.controls.DragProxy.prototype, {
      _onDrag: function(t, e, i) {
        i =
          i.originalEvent && i.originalEvent.touches
        ...
        (o ||
          this._layoutManager.config.settings.constrainDragToContainer !==
            !0) &&
          this._setDropPosition(n, s);
      },
      _setDropPosition: function(t, e) {
        this.element.css({ left: t, top: e }),
          (this._area = this._layoutManager._$getArea(t, e)),
          null !== this._area &&
            ((this._lastValidArea = this._area),
            this._area.contentItem._$highlightDropZone(t, e, this._area));
      },
      _onDrop: function() {
      ...
      _updateTree: function() {
        this._contentItem.parent &&
          this._contentItem.parent.removeChild(this._contentItem, !0),
    ...
    (lm.controls.Header = function(t, e) {
      lm.utils.EventEmitter.call(this),
        ...
        this.layoutManager.config.settings.selectionEnabled === !0 &&
        ...
        $(document).mouseup(
          lm.utils.fnBind(this._hideAdditionalTabsDropdown, this)
        ),
    ...
    lm.utils.copy(lm.controls.Header.prototype, {
      createTab: function(t, e) {
        ...
        for (n = 0; n < this.tabs.length; n++)
          if (this.tabs[n].contentItem === t) return;
        return (
          (i = new lm.controls.Tab(this, t)),
          0 === this.tabs.length
            ? (this.tabs.push(i), void this.tabsContainer.append(i.element))
            : (void 0 === e && (e = this.tabs.length),
              e > 0
                ? this.tabs[e - 1].element.after(i.element)
                : this.tabs[0].element.before(i.element),
              this.tabs.splice(e, 0, i),
              void this._updateTabSizes())
        );
      },
      removeTab: function(t) {
        for (var e = 0; e < this.tabs.length; e++)
          if (this.tabs[e].contentItem === t)
            return this.tabs[e]._$destroy(), void this.tabs.splice(e, 1);
        throw new Error('contentItem is not controlled by this header');
      },
      setActiveContentItem: function(t) {
        var e, i, n, s;
        for (e = 0; e < this.tabs.length; e++)
          (n = this.tabs[e].contentItem === t),
            this.tabs[e].setActive(n),
            n === !0 &&
              ((this.activeContentItem = t),
              (this.parent.config.activeItemIndex = e));
        if (
          this._lastVisibleTabIndex !== -1 &&
          this.parent.config.activeItemIndex > this._lastVisibleTabIndex
        ) {
          for (
            s = this.tabs[this.parent.config.activeItemIndex],
              i = this.parent.config.activeItemIndex;
            i > 0;
            i--
          )
      ...
      _$setClosable: function(t) {
        return (
          !(!this.closeButton || !this._isClosable()) &&
          (this.closeButton.element[t ? 'show' : 'hide'](), !0)
        );
      },
      _$destroy: function() {
      ...
      _createControls: function() {
        ...
        (h = lm.utils.fnBind(this._showAdditionalTabsDropdown, this)),
          ...
          this._getHeaderSetting('popout') &&
            ((e = lm.utils.fnBind(this._onPopoutClick, this)),
            (i = this._getHeaderSetting('popout')),
            new lm.controls.HeaderButton(this, i, 'lm_popout', e)),
          ...
          this._isClosable() &&
            ((t = lm.utils.fnBind(this.parent.remove, this.parent)),
            (i = this._getHeaderSetting('close')),
      ...
      _onPopoutClick: function() {
        this.layoutManager.config.settings.popoutWholeStack === !0
          ? this.parent.popout()
      ...
      _updateTabSizes: function() {
        if (0 !== this.tabs.length) {
          ...
          this.element.css(t(!this.parent._sided), ''),
            this.element[t(this.parent._sided)](
          ...
          for (
            ...
            (e = this.tabs[i].element),
              ...
              (r += s),
              r > o && a
                ? (e.data('lastTabWidth', s),
                  this.tabDropdownContainer.append(e))
                : ((a = !0),
                  (this._lastVisibleTabIndex = i),
                  e.removeData('lastTabWidth'),
                  this.tabsContainer.append(e));
    ...
    lm.utils.copy(lm.controls.Splitter.prototype, {
      ...
      _createElement: function() {
        var t = $(
          '<div class="lm_splitter"><div class="lm_drag_handle"></div></div>'
        );
        return (
          t.addClass('lm_' + (this._isVertical ? 'vertical' : 'horizontal')),
          t[this._isVertical ? 'height' : 'width'](this._size),
          t
        );
      }
    }),
    (lm.controls.Tab = function(t, e) {
      (this.header = t),
        ...
        this._layoutManager.config.settings.reorderEnabled === !0 &&
          e.config.reorderEnabled === !0 &&
          ((this._dragListener = new lm.utils.DragListener(this.element)),
          this._dragListener.on('dragStart', this._onDragStart, this)),
    ...
    (lm.controls.Tab._template =
      '<li class="lm_tab"><i class="lm_left"></i><span class="lm_title"></span><div class="lm_close_tab"></div><i class="lm_right"></i></li>'),
    lm.utils.copy(lm.controls.Tab.prototype, {
      setTitle: function(t) {
        this.element.attr('title', lm.utils.stripTags(t)),
          this.titleElement.html(t);
      },
      ...
      _onDragStart: function(t, e) {
        this.contentItem.parent.isMaximised === !0 &&
    ...
    lm.utils.copy(lm.controls.TransitionIndicator.prototype, {
      ...
      _nextAnimationFrame: function() {
        ...
        e.opacity = 0;
        for (t in this._fromDimensions)
          n[t] = this._fromDimensions[t] + (e[t] - this._fromDimensions[t]) * i;
        this._element.css(n),
    ...
    lm.utils.copy(lm.items.AbstractContentItem.prototype, {
      ...
      callDownwards: function(t, e, i, n) {
        var s;
        for (
          i !== !0 && n !== !0 && this[t].apply(this, e || []), s = 0;
          s < this.contentItems.length;
          s++
        )
          this.contentItems[s].callDownwards(t, e, i);
      ...
      select: function() {
        this.layoutManager.selectedItem !== this &&
          (this.layoutManager.selectItem(this, !0),
      ...
      setTitle: function(t) {
        (this.config.title = t),
          this.emit('titleChanged', t),
          this.emit('stateChanged');
      },
      hasId: function(t) {
        return (
          !!this.config.id &&
          ('string' == typeof this.config.id
            ? this.config.id === t
            : this.config.id instanceof Array
            ? lm.utils.indexOf(t, this.config.id) !== -1
            : void 0)
        );
      },
      addId: function(t) {
        this.hasId(t) ||
          (this.config.id
            ? 'string' == typeof this.config.id
              ? (this.config.id = [this.config.id, t])
              : this.config.id instanceof Array && this.config.id.push(t)
            : (this.config.id = t));
      },
      removeId: function(t) {
      ...
      getItemsByFilter: function(t) {
        var e = [],
          i = function(n) {
            for (var s = 0; s < n.contentItems.length; s++)
              t(n.contentItems[s]) === !0 && e.push(n.contentItems[s]),
                i(n.contentItems[s]);
          };
        return i(this), e;
      },
      getItemsById: function(t) {
        return this.getItemsByFilter(function(e) {
          return e.config.id instanceof Array
            ? lm.utils.indexOf(t, e.config.id) !== -1
            : e.config.id === t;
        });
      },
      ...
      _callOnActiveComponents: function(t) {
        ...
        for (i = 0; i < n.length; i++)
          (e = n[i].getActiveContentItem()),
            e && e.isComponent && e.container[t]();
      },
      _$destroy: function() {
        this.emitBubblingEvent('beforeItemDestroyed'),
          this.callDownwards('_$destroy', [], !0, !0),
          this.element.remove(),
      ...
      _$init: function() {
        var t;
        for (this.setSize(), t = 0; t < this.contentItems.length; t++)
          this.childElementContainer.append(this.contentItems[t].element);
        (this.isInitialised = !0),
      ...
      _createContentItems: function(t) {
        var e, i;
        if (!(t.content instanceof Array))
          throw new lm.errors.ConfigurationError('content must be an Array', t);
        for (i = 0; i < t.content.length; i++)
          (e = this.layoutManager.createContentItem(t.content[i], this)),
            this.contentItems.push(e);
      },
      _extendItemNode: function(t) {
        for (var e in lm.config.itemDefaultConfig)
          void 0 === t[e] && (t[e] = lm.config.itemDefaultConfig[e]);
        return t;
      },
      _propagateEvent: function(t, e) {
        e instanceof lm.utils.BubblingEvent &&
          ...
          this.isInitialised === !0 &&
          (this.isRoot === !1 && this.parent
            ? this.parent.emit.apply(
                this.parent,
                Array.prototype.slice.call(arguments, 0)
              )
            : this._scheduleEventPropagationToLayoutManager(t, e));
      },
      _scheduleEventPropagationToLayoutManager: function(t, e) {
        lm.utils.indexOf(t, this._throttledEvents) === -1
          ...
          : this._pendingEventPropagations[t] !== !0 &&
            ((this._pendingEventPropagations[t] = !0),
            lm.utils.animFrame(
              lm.utils.fnBind(this._propagateEventToLayoutManager, this, [t, e])
            ));
      },
    ...
    lm.utils.copy(lm.items.Root.prototype, {
      ...
      setSize: function(t, e) {
        (t = 'undefined' == typeof t ? this._containerElement.width() : t),
          ...
          this.contentItems[0] &&
            (this.contentItems[0].element.width(t),
            this.contentItems[0].element.height(e));
      },
      _$highlightDropZone: function(t, e, i) {
      ...
      _$onDrop: function(t, e) {
        ...
        if (
          (t.isComponent &&
            ((i = this.layoutManager.createContentItem(
              { type: 'stack', header: t.config.header || {} },
              this
            )),
            i._$init(),
            i.addChild(t),
          ...
          if (!r instanceof lm.items.RowOrColumn || r.type != n) {
            ...
            this.replaceChild(r, a),
              a.addChild(t, o ? 0 : void 0, !0),
              a.addChild(r, o ? void 0 : 0, !0),
              (r.config[s] = 50),
              (t.config[s] = 50),
              a.callDownwards('setSize');
          } else {
            var h = r.contentItems[o ? 0 : r.contentItems.length - 1];
            r.addChild(t, o ? 0 : void 0, !0),
              (h.config[s] *= 0.5),
              (t.config[s] = h.config[s]),
              r.callDownwards('setSize');
          }
    ...
    (lm.items.RowOrColumn = function(t, e, i, n) {
      lm.items.AbstractContentItem.call(this, e, i, n),
        ...
        (this.isColumn = t),
        (this.element = $(
          '<div class="lm_item lm_' + (t ? 'column' : 'row') + '"></div>'
        )),
        (this.childElementContainer = this.element),
    ...
    lm.utils.copy(lm.items.RowOrColumn.prototype, {
      addChild: function(t, e, i) {
        ...
        if (
          ...
          void 0 === e && (e = this.contentItems.length),
          this.contentItems.length > 0
            ? ((r = this._createSplitter(Math.max(0, e - 1)).element),
              e > 0
                ? (this.contentItems[e - 1].element.after(r),
                  r.after(t.element))
                : (this.contentItems[0].element.before(r), r.before(t.element)))
            : this.childElementContainer.append(t.element),
        ...
        for (o = 0; o < this.contentItems.length; o++)
          this.contentItems[o] === t
            ? (t.config[this._dimension] = n)
            : ((s = this.contentItems[o].config[this._dimension] *=
                (100 - n) / 100),
              (this.contentItems[o].config[this._dimension] = s));
      ...
      removeChild: function(t, e) {
        ...
        for (
          this._splitter[r] &&
            (this._splitter[r]._$destroy(), this._splitter.splice(r, 1)),
            i = 0;
          i < this.contentItems.length;
          i++
        )
          this.contentItems[i] !== t &&
            (this.contentItems[i].config[this._dimension] +=
              s / (this.contentItems.length - 1));
        lm.items.AbstractContentItem.prototype.removeChild.call(this, t, e),
          1 === this.contentItems.length && this.config.isClosable === !0
            ? ((n = this.contentItems[0]),
              (this.contentItems = []),
              this.parent.replaceChild(this, n, !0))
            : (this.callDownwards('setSize'),
              this.emitBubblingEvent('stateChanged'));
      },
      replaceChild: function(t, e) {
        var i = t.config[this._dimension];
        lm.items.AbstractContentItem.prototype.replaceChild.call(this, t, e),
          (e.config[this._dimension] = i),
          this.callDownwards('setSize'),
          this.emitBubblingEvent('stateChanged');
      },
      setSize: function() {
        this.contentItems.length > 0 &&
          (this._calculateRelativeSizes(), this._setAbsoluteSizes()),
          this.emitBubblingEvent('stateChanged'),
          this.emit('resize');
      },
      _$init: function() {
        if (this.isInitialised !== !0) {
          var t;
          for (
            lm.items.AbstractContentItem.prototype._$init.call(this), t = 0;
            t < this.contentItems.length - 1;
            t++
          )
            this.contentItems[t].element.after(this._createSplitter(t).element);
        }
      },
      _setAbsoluteSizes: function() {
        ...
        for (t = 0; t < this.contentItems.length; t++)
          e.additionalPixel - t > 0 && e.itemSizes[t]++,
            this._isColumn
              ? (this.contentItems[t].element.width(e.totalWidth),
                this.contentItems[t].element.height(e.itemSizes[t]))
              : (this.contentItems[t].element.width(e.itemSizes[t]),
                this.contentItems[t].element.height(e.totalHeight));
      },
      _calculateAbsoluteSizes: function() {
        var t,
          ...
          a = [];
        for (
          this._isColumn ? (o -= n) : (s -= n), t = 0;
          t < this.contentItems.length;
          t++
        )
          (i = this._isColumn
            ? Math.floor(o * (this.contentItems[t].config.height / 100))
            : Math.floor(s * (this.contentItems[t].config.width / 100))),
            (r += i),
            a.push(i);
        return (
          (e = Math.floor((this._isColumn ? o : s) - r)),
          { itemSizes: a, additionalPixel: e, totalWidth: s, totalHeight: o }
        );
      },
      _calculateRelativeSizes: function() {
        ...
        for (t = 0; t < this.contentItems.length; t++)
          void 0 !== this.contentItems[t].config[n]
            ? (e += this.contentItems[t].config[n])
            : i.push(this.contentItems[t]);
        ...
        for (t = 0; t < this.contentItems.length; t++)
          this.contentItems[t].config[n] =
            (this.contentItems[t].config[n] / e) * 100;
      ...
      _respectMinItemWidth: function() {
        var t,
          e,
          n,
          s = this.layoutManager.config.dimensions
        ...
        if (!(this._isColumn || !s || this.contentItems.length <= 1)) {
          for (
            o = this._calculateAbsoluteSizes(), i = 0;
            i < this.contentItems.length;
            i++
          )
            (c = this.contentItems[i]),
              (m = o.itemSizes[i]),
              m < s
                ? ((h += s - m), (n = { width: s }))
                : ((a += m - s), (n = { width: m }), r.push(n)),
              d.push(n);
          if (!(0 === h || h > a)) {
            for (t = h / a, l = h, i = 0; i < r.length; i++)
              (n = r[i]),
                (e = Math.round((n.width - s) * t)),
                (l -= e),
                (n.width -= e);
            for (
              0 !== l && (d[d.length - 1].width -= l), i = 0;
              i < this.contentItems.length;
              i++
            )
              this.contentItems[i].config.width =
                (d[i].width / o.totalWidth) * 100;
          }
        }
      },
      _createSplitter: function(t) {
        ...
        return (
          ...
          e.on(
            'dragStop',
            lm.utils.fnBind(this._onSplitterDragStop, this, [e]),
            this
          ),
          e.on(
            'dragStart',
            lm.utils.fnBind(this._onSplitterDragStart, this, [e]),
            this
          ),
      ...
      _onSplitterDragStart: function(t) {
        ...
        (this._splitterPosition = 0),
          (this._splitterMinPosition =
            -1 * (e.before.element[this._dimension]() - (s || i))),
          (this._splitterMaxPosition =
            e.after.element[this._dimension]() - (r || i));
      },
      _onSplitterDrag: function(t, e, i) {
        var n = this._isColumn ? i : e;
        n > this._splitterMinPosition &&
          n < this._splitterMaxPosition &&
          ((this._splitterPosition = n),
          t.element.css(this._isColumn ? 'top' : 'left', n));
      },
      _onSplitterDragStop: function(t) {
        var e = this._getItemsForSplitter(t),
          ...
          o =
            e.before.config[this._dimension] + e.after.config[this._dimension];
        (e.before.config[this._dimension] = s * o),
          (e.after.config[this._dimension] = (1 - s) * o),
          t.element.css({ top: 0, left: 0 }),
          lm.utils.animFrame(
    ...
    lm.utils.copy(lm.items.Stack.prototype, {
      setSize: function() {
        ...
        for (
          this.childElementContainer.width(i),
            this.childElementContainer.height(n),
            t = 0;
          t < this.contentItems.length;
          t++
        )
          this.contentItems[t].element.width(i).height(n);
      ...
      _$init: function() {
        ...
        if (this.isInitialised !== !0) {
          for (
            ...
            this.header.createTab(this.contentItems[t]),
              this.contentItems[t]._$hide();
          if (this.contentItems.length > 0) {
      ...
      removeChild: function(t, e) {
        ...
        lm.items.AbstractContentItem.prototype.removeChild.call(this, t, e),
          ...
          this.contentItems.length > 0
            ? this.setActiveContentItem(this.contentItems[Math.max(i - 1, 0)])
            : (this._activeContentItem = null),
          this._$validateClosability(),
          this.emitBubblingEvent('stateChanged');
      },
      _$validateClosability: function() {
        var t, e, i;
        for (
          t = this.header._isClosable(), i = 0, e = this.contentItems.length;
          i < e && t;
          i++
        )
          t = this.contentItems[i].config.isClosable;
      ...
      _$onDrop: function(t) {
        if ('header' === this._dropSegment)
          return (
            this._resetHeaderDropZone(), void this.addChild(t, this._dropIndex)
          );
        ...
        t.isComponent &&
          ...
          (t = i)),
          a
            ? ((e = lm.utils.indexOf(this, this.parent.contentItems)),
              this.parent.addChild(t, r ? e : e + 1, !0),
              (this.config[l] *= 0.5),
              (t.config[l] = this.config[l]),
      ...
      _$highlightDropZone: function(t, e) {
        ...
        for (i in this._contentAreaDimensions)
          if (
            ((n = this._contentAreaDimensions[i].hoverArea),
            n.x1 < t && n.x2 > t && n.y1 < e && n.y2 > e)
          )
            return void ('header' === i
              ? ((this._dropSegment = 'header'),
                this._highlightHeaderDropZone(this._sided ? e : t))
              : (this._resetHeaderDropZone(), this._highlightBodyDropZone(i)));
      },
      _$getArea: function() {
        ...
        return (
          (this._contentAreaDimensions = {
            header: {
              hoverArea: { x1: e.x1, y1: e.y1, x2: e.x2, y2: e.y2 },
              highlightArea: { x1: e.x1, y1: e.y1, x2: e.x2, y2: e.y2 }
            }
          }),
          this._activeContentItem && this._activeContentItem.isComponent === !1
            ...
            ? ((this._contentAreaDimensions.body = {
                hoverArea: { x1: i.x1, y1: i.y1, x2: i.x2, y2: i.y2 },
                highlightArea: { x1: i.x1, y1: i.y1, x2: i.x2, y2: i.y2 }
              }),
      ...
      _highlightHeaderDropZone: function(t) {
        ...
        if (0 === m)
          return (
            (a = this.header.element.offset()),
            void this.layoutManager.dropTargetIndicator.highlightArea({
              x1: a.left,
              x2: a.left + 100,
        ...
        for (e = 0; e < m; e++)
          if (
            ((i = this.header.tabs[e].element),
            (o = i.offset()),
            this._sided
              ? ((s = o.top), (n = o.left), (h = i.height()))
              : ((s = o.left), (n = o.top), (h = i.width())),
            t > s && t < s + h)
          ) {
            c = !0;
            break;
        ...
        if (!(c === !1 && t < s)) {
          if (
            ...
            t < l
              ? ((this._dropIndex = e),
                i.before(this.layoutManager.tabDropPlaceholder))
              : ((this._dropIndex = Math.min(e + 1, m)),
                i.after(this.layoutManager.tabDropPlaceholder)),
            this._sided)
          )
            return (
              (placeHolderTop = this.layoutManager.tabDropPlaceholder.offset()
                .top),
              void this.layoutManager.dropTargetIndicator.highlightArea({
                x1: n,
                x2: n + i.innerHeight(),
                y1: placeHolderTop,
                y2:
                  placeHolderTop + this.layoutManager.tabDropPlaceholder.width()
              })
            );
          (r = this.layoutManager.tabDropPlaceholder.offset().left),
      ...
      _setupHeaderPosition: function() {
        ...
        if (
          ...
          this.header.element[e](this.childElementContainer),
            this.callDownwards('setSize');
        }
      },
    ...
    lm.utils.copy(lm.utils.ConfigMinifier.prototype, {
      ...
      _nextLevel: function(t, e, i) {
        ...
        for (n in t)
          t instanceof Array && (n = parseInt(n, 10)),
            t.hasOwnProperty(n) &&
              ((s = this[i](n, this._keys)),
              'object' == typeof t[n]
                ? ((e[s] = t[n] instanceof Array ? [] : {}),
                  this._nextLevel(t[n], e[s], i))
                : (e[s] = this[i](t[n], this._values)));
      },
      _min: function(t, e) {
      ...
      _max: function(t, e) {
        return 'string' == typeof t && 1 === t.length
          ? e[parseInt(t, 36)]
          : 'string' == typeof t && '___' === t.substr(0, 3)
          ? t[3]
          : t;
      }
    }),
    ...
    (lm.utils.EventHub.prototype._onEventFromThis = function() {
      ...
      this._layoutManager.isSubWindow &&
        t[0] !== this._dontPropagateToParent &&
        this._propagateToParent(t),
        this._propagateToChildren(t),
        (this._dontPropagateToParent = null),
        (this._childEventSource = null);
    }),
    ...
    (lm.utils.EventHub.prototype._onEventFromChild = function(t) {
      (this._childEventSource = t.originalEvent.__gl),
        this.emit.apply(this, t.originalEvent.__glArgs);
    }),
    (lm.utils.EventHub.prototype._propagateToParent = function(t) {
      var e,
        i = 'gl_child_event';
      document.createEvent
        ? ((e = window.opener.document.createEvent('HTMLEvents')),
          e.initEvent(i, !0, !0))
        : ((e = window.opener.document.createEventObject()), (e.eventType = i)),
        (e.eventName = i),
        (e.__glArgs = t),
        (e.__gl = this._layoutManager),
        document.createEvent
          ? window.opener.dispatchEvent(e)
          : window.opener.fireEvent('on' + e.eventType, e);
    }),
    (lm.utils.EventHub.prototype._propagateToChildren = function(t) {
      var e, i;
      for (i = 0; i < this._layoutManager.openPopouts.length; i++)
        (e = this._layoutManager.openPopouts[i].getGlInstance()),
          e &&
            e !== this._childEventSource &&
            e.eventHub._$onEventFromParent(t);
    }),
    ...
    lm.utils.copy(lm.utils.ReactComponentHandler.prototype, {
      ...
      _onUpdate: function(t, e) {
        this._container.setState(e),
          this._originalComponentWillUpdate.call(this._reactComponent, t, e);
      },
      _getReactClass: function() {
        ...
        if (((t = this._container.layoutManager.getComponent(e)), !t))
          throw new Error(
            'React component "' +
              e +
              '" not found. Please register all components with GoldenLayout using `registerComponent(name, component)`'
          );
        return t;
      },
